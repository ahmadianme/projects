...
def parse_args():
    ...
    parser.add_argument("--maxCaptionLength", default=20, type=int, help='Maximum length for captions.')
    parser.add_argument("--maxObjectClassLength", default=40, type=int, help='Maximum length for captions.')
